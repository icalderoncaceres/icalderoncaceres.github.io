	...
	render(){
		...
		<div className="media">
			<div className="media-content">
				<p className="title is-4">{this.props.brand}</p>
				<p className="subtitle is-6 opacity">
					{this.props.productname}<br/>
					Vendido y entregado: <a href="#" target="_blank">{this.props.seller}</a>					
				</p>
			</div>
			<div className="media-right opacity">
